...
const UpgradePlans = () => {
  ...
  const upgradeUser = useMutation(api.user.upgradePlan)
  const {user} = useUser()
  const onPaymentSuccess = async () =>{
    const res = await upgradeUser({email:user?.primaryEmailAddress.emailAddress})
  ...
  return (
    <div>
      ...
      <p className='mt-3'>Upgrade Your Plan To Upload More PDF</p>
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 mt-8">
